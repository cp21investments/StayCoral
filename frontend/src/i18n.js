...
const dict = {
  en: {
    ...
    bk: {
      night: "night", select: "Select your dates",
      guests: "guests", nights: "nights", cleaning: "Cleaning fee", total: "Total",
      name: "Full name", email: "Email", phone: "Phone / WhatsApp",
      request: "Request to Book", sending: "Sending…",
      note: "You won't be charged yet — we confirm availability first.",
      success: "Request sent!", successBody: "We received your booking request. We'll confirm availability and send you payment details shortly.",
      conflict: "Those dates are no longer available. Please choose different ones.",
      error: "Something went wrong. Please try again.",
      invalid: "Your selection includes unavailable dates.",
      prefer: "Prefer to book through Airbnb?", viewAirbnb: "View on Airbnb",
      alreadyTitle: "Already use Airbnb?", alreadyBody: "You can also find us on Airbnb.", alreadyCta: "View our Airbnb listing",
      reviewsTitle: "What our guests say", source: "Airbnb guest",
    },
    common: { chat: "Chat with us", viewAll: "View all stays", back: "Back to stays" },
  },
  es: {
    nav: { stays: "Alojamientos", cartagena: "Cartagena", story: "Historia", journal: "Diario", contact: "Contacto", book: "Reserva Directa" },
    hero: {
      brand: "Stay Coral Collection",
    ...
    bk: {
      night: "noche", select: "Selecciona tus fechas",
      guests: "huéspedes", nights: "noches", cleaning: "Tarifa de limpieza", total: "Total",
      name: "Nombre completo", email: "Correo", phone: "Teléfono / WhatsApp",
      request: "Solicitar Reserva", sending: "Enviando…",
      note: "Aún no se te cobrará — primero confirmamos disponibilidad.",
      success: "¡Solicitud enviada!", successBody: "Recibimos tu solicitud de reserva. Confirmaremos disponibilidad y te enviaremos los detalles de pago muy pronto.",
      conflict: "Esas fechas ya no están disponibles. Elige otras, por favor.",
      error: "Algo salió mal. Inténtalo de nuevo.",
      invalid: "Tu selección incluye fechas no disponibles.",
      prefer: "¿Prefieres reservar por Airbnb?", viewAirbnb: "Ver en Airbnb",
      alreadyTitle: "¿Ya usas Airbnb?", alreadyBody: "También puedes encontrarnos en Airbnb.", alreadyCta: "Ver nuestro anuncio en Airbnb",
      reviewsTitle: "Lo que dicen nuestros huéspedes", source: "Huésped de Airbnb",
    },
  },
};
